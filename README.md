...
![screenshot](https://raw.githubusercontent.com/linuxdeepin/gxde-boot-maker/master/docs/gxde-boot-maker.png)
...
The only binary release is from Deepin OS iso for now. You can download iso from: https://www.deepin.org/original/gxde-boot-maker/. Or you can find binary file on the root of iso.
...
```bash
sudo apt-get install gxde-boot-maker
```
